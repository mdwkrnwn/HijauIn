...
export default function Register() {
  return (
    <div className=" w-full bg-white rounded-[3rem] shadow-2xl overflow-hidden flex min-h-200">
      ...
      <div className="w-1/2 bg-linear-to-br from-green-50 to-primary-light relative p-16">
        <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full text-primary font-semibold text-base w-max mb-8">
          <FaLeaf /> Aksi Kecil, Dampak Besar
        </div>
        <h1 className="text-6xl font-extrabold text-gray-900 leading-tight mb-6">
          Mulai Perjalanan <span className="text-primary">Hijau</span> mu Sekarang!
        </h1>
      ...
      <div className="w-1/2 p-16 bg-white">
        <div className="text-center mb-12">
          <div className="w-20 h-20 bg-primary-light rounded-full mx-auto mb-6 flex items-center justify-center text-primary text-4xl">
            <FaUsers />
          </div>
        ...
        <form className="space-y-8">
          <div>
            ...
            <input type="text" placeholder="Masukkan nama lengkap kamu" className="w-full px-6 py-4 rounded-xl border border-gray-300 text-base focus:ring-2 focus:ring-primary outline-none" />
          </div>
          <div>
            <label className="block text-base font-bold text-gray-700 mb-3">Email</label>
            <input type="email" placeholder="Masukkan email aktif kamu" className="w-full px-6 py-4 rounded-xl border border-gray-300 text-base focus:ring-2 focus:ring-primary outline-none" />
          </div>
          <div>
            <label className="block text-base font-bold text-gray-700 mb-3">Kata Sandi</label>
            <div className="relative">
              <input type="password" placeholder="Buat kata sandi (min. 8 karakter)" className="w-full px-6 py-4 rounded-xl border border-gray-300 text-base focus:ring-2 focus:ring-primary outline-none" />
          ...
          <div>
            ...
            <div className="relative">
              <input type="password" placeholder="Konfirmasi kata sandi kamu" className="w-full px-6 py-4 rounded-xl border border-gray-300 text-base focus:ring-2 focus:ring-primary outline-none" />
              <FaEyeSlash className="absolute right-6 top-5 text-xl text-gray-400 cursor-pointer" />
            </div>
          </div>

          <div className="flex items-start gap-4">
            <input type="checkbox" className="mt-1 w-5 h-5 rounded text-primary focus:ring-primary border-gray-300" />
            <label className="text-base text-gray-600 leading-relaxed">
              Saya setuju dengan <Link href="#" className="text-primary font-bold">Syarat & Ketentuan</Link> dan <Link href="#" className="text-primary font-bold">Kebijakan Privasi HijauIn</Link>
            </label>
          </div>

          <button type="button" className="w-full bg-primary text-white py-5 rounded-xl font-bold text-lg hover:bg-green-700 transition">
