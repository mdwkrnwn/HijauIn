        ...
        <div className="bg-white rounded-[3rem] p-10 flex gap-10 shadow-sm border border-gray-100 items-stretch">
          <div className="flex flex-col justify-between w-1/2 py-6">
            <div>
              ...
              <h1 className="mb-4 text-6xl font-extrabold text-gray-900">Green Campus <FaLeaf className="text-primary inline" /></h1>
              <div className="flex items-center gap-3 mb-8 text-xl font-medium text-gray-600">
                <FaMapMarkerAlt className="text-primary" /> Surabaya, Jawa Timur
              </div>
              <p className="max-w-md mb-8 text-lg leading-relaxed text-gray-600">
                Komunitas mahasiswa yang bergerak dalam aksi lingkungan di kampus dan sekitarnya. Bersama kita ciptakan kampus hijau, bersih, dan berkelanjutan.
              </p>
              <div className="flex gap-3 mb-12">
                <span className="bg-primary-light/50 text-primary border-primary-light px-4 py-2 text-base font-medium border rounded-full">Edukasi</span>
                <span className="bg-primary-light/50 text-primary border-primary-light px-4 py-2 text-base font-medium border rounded-full">Penghijauan</span>
                <span className="bg-primary-light/50 text-primary border-primary-light px-4 py-2 text-base font-medium border rounded-full">Daur Ulang</span>
              </div>
            </div>
          ...
          <div className="w-1/2 relative rounded-[2rem] overflow-hidden">
            <Image src="https://picsum.photos/seed/planttree/800/800" alt="Community Activity" fill className="object-cover" />
            <div className="bottom-6 right-6 rounded-2xl absolute flex items-center gap-4 p-4 bg-white border border-gray-100 shadow-lg">
              ...
              <div>
                <div className="text-xl font-bold leading-tight text-gray-900">1.243+</div>
