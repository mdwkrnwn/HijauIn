...
export function Komunitas({ communities }: { communities: Community[] }) {
  const impacts = [
    {
      ...
      <section className="relative w-full h-175 flex items-center px-16 bg-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            priority
          />
          <div className="bg-linear-to-r from-white via-white/90 to-transparent absolute inset-0 w-3/4"></div>
        </div>

        {/* Content */}
        <div className="relative z-10 -mt-10 w-full max-w-140">
          {/* Badge */}
          <div
            data-aos="fade-down"
          ...
          <p
            ...
            data-aos-delay="300"
            data-aos-duration="900"
            className="mb-8 max-w-117.5 text-[18px] leading-9 text-[#4B5563]">
          ...
          <div
            ...
            <button className="flex h-14 items-center gap-2 rounded-xl bg-[#11773D] px-7 text-[16px] font-semibold text-white transition hover:bg-[#0E6534]">
              <FaUserPlus className="text-[15px]" />
              Gabung Komunitas
            </button>

            <button className="flex h-14 items-center gap-2 rounded-xl border border-[#D8E0DA] bg-white px-7 text-[16px] font-semibold text-[#243126] transition hover:bg-[#F8FAF8]">
      ...
      <section className=" relative w-full px-16 py-24 mx-auto">
        ...
        <div className="relative">
          <div className="grid grid-cols-5 gap-5">
            {communities.map((com, idx) => {
              ...
              return (
                ...
                >
                  {/* Thumbnail */}
                  <div className="relative h-48.75 overflow-hidden rounded-t-[18px]">
                    <Image
                      src={com.image}
                      alt={com.name}
                      fill
                  ...
                  {/* Logo */}
                  <div className="absolute left-5 top-38.75 z-30 flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-lg ring-4 ring-white">
                    <div className="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-[#EEF8F1]">
          ...
          <button
            ...
            data-aos-delay="700"
            data-aos-duration="700"
            className="absolute -right-5.5 top-1/2 z-30 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white shadow-lg transition hover:scale-105">
      ...
      <section className=" w-full px-16 pb-24 mx-auto">
        ...
        <div className="grid grid-cols-4 gap-5">
          {events.map((act, idx) => (
            ...
            >
              {/* Thumbnail */}
              <div className="relative h-51.25 overflow-hidden">
                <Image
                  src={act.img}
                  alt={act.title}
                  fill
                ...
                {/* Date */}
                <div className="absolute left-4 top-4 flex h-14 w-14 flex-col items-center justify-center rounded-xl bg-[#11773D] text-white shadow-md">
              ...
              >
                ...
                {index !== 4 && (
                  <>
                    ...
                    <FaLeaf className="absolute left-[calc(100%-10px)] top-7.5 z-10 text-[10px] text-[#69B35A]" />
                  </>
                )}

                {/* Icon */}
                <div className="mb-6 flex h-25 w-25 items-center justify-center rounded-full bg-[#F2FAF4]">
                  <div className="flex h-14.5 w-14.5 items-center justify-center rounded-full">
                    <Image
                      src={item.icon}
                      alt={item.title}
                      width={55}
        ...
        <div className="relative overflow-hidden rounded-[22px] bg-linear-to-r from-[#0D4E2E] to-[#0B4A2A] shadow-lg">
          <div className="flex h-113.75">
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="150"
              data-aos-duration="900" className="flex w-[36%] flex-col justify-center px-8 text-white">
              ...
              <div
                ...
                <button className="flex h-11.5 items-center gap-2 rounded-xl bg-[#1D8641] px-6 text-[14px] font-medium text-white transition hover:bg-[#2F8E48]">
                  Gabung Sekarang
                  <FaUserPlus className="text-[13px]" />
                </button>

                <button className="flex h-11.5 items-center gap-2 rounded-xl border border-[#7A9B86] px-6 text-[14px] font-medium text-white transition hover:bg-white/10">
                  Buat Komunitasmu
            ...
            <div
              ...
              <div className="w-full rounded-2xl bg-[#1B5B39]/90 p-6">
                ...
                <div className="space-y-5">
                  ...
                  <div
                    data-aos="fade-left"
                    data-aos-delay="650" className="flex items-center justify-between">
                    <span className="flex items-center gap-3 text-[14px] text-[#D8E7DE]">
