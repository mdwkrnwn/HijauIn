...
export default function HowItWorks() {
  return (
    <div className="w-full flex flex-col items-center">
      {/* Header Section */}
      <section className="w-full px-16 py-24 text-center bg-primary-light relative overflow-hidden">
      ...
      <section className="w-full px-16 py-24 bg-white">
        <h2 className="text-4xl font-bold text-center mb-24">Bagaimana <span className="text-primary">HijauIn</span> Bekerja?</h2>
        <div className="flex justify-between items-start relative">
          ...
          {[
            ...
            <div key={idx} className="flex flex-col items-center text-center relative z-10 w-64 bg-white px-4">
              <div className="w-12 h-12 bg-white border-4 border-primary text-primary font-bold rounded-full flex items-center justify-center text-lg mb-4">
                {step.num}
              </div>
              <div className="w-24 h-24 bg-primary-light rounded-full flex items-center justify-center text-4xl text-primary mb-6 shadow-sm">
                {step.icon}
              </div>
      ...
      <section className="w-full px-16 py-24 bg-gray-50 text-center">
        <h2 className="text-4xl font-bold mb-16">Alur Sistem <span className="text-primary">HijauIn</span></h2>
        <div className="flex items-center justify-center gap-4">
          {[
            ...
            <div key={i} className="flex items-center gap-4">
              ...
              {i < arr.length - 1 && <FaArrowRight className="text-2xl text-primary" />}
            </div>
          ))}
        </div>
      </section>
