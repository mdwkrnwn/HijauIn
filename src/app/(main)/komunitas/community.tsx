    ...
    <div className="bg-white flex flex-col items-center w-full pb-24">
      ...
      <section className="relative w-full h-175 flex items-center px-16 bg-white overflow-hidden">
        ...
        <div className="relative z-10 -mt-10 w-full max-w-140">
          ...
          {/* Description */}
          <p className="mb-8 max-w-117.5 text-[18px] leading-9 text-[#4B5563]">
      ...
      <section className="max-w-1080p relative w-full px-16 py-24 mx-auto">
        ...
        <div className="relative">
          ...
          {/* Arrow */}
          <button className="absolute -right-5.5 top-1/2 z-30 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white shadow-lg transition hover:scale-105">
