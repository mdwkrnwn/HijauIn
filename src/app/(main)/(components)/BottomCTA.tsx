...
function BottomCTA() {
  return (
    <section className="w-[90vw] bg-primary-light rounded-[3rem] px-16 flex items-center justify-between relative overflow-hidden shadow-sm">
      {/* Ilustrasi Kiri */}
      <div className="h-75 relative flex items-start justify-start w-1/3">
        <Image src="/assets/beranda/yukmulai.png" alt="People holding earth" fill className="object-contain" />
      </div>
      ...
      <div className="z-10 flex flex-col items-end justify-center w-1/3 gap-4">
        <button className="bg-primary hover:bg-green-700 rounded-xl flex items-center justify-center w-2/3 gap-3 py-4 text-lg font-bold text-white transition shadow-lg">
          Daftar Gratis Sekarang <FaArrowRight />
        </button>
        <button className="border-primary text-primary hover:bg-primary-light rounded-xl flex items-center justify-center w-2/3 gap-3 py-4 text-lg font-bold transition bg-white border-2">
