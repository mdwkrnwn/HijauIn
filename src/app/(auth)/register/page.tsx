          ...
          <div className="lg:w-1/2 relative flex flex-col justify-between w-full">
            ...
            <div>
              ...
              <h2 className="mb-4 text-4xl lg:text-5xl font-bold leading-tight text-[#0B0F1F]">
                Mulai Perjalanan
                <br />
                <span className="text-[#11773D]">Hijau</span> mu Sekarang!
              </h2>

              <p className="text-base text-gray-600 font-medium leading-relaxed max-w-md">
                Buat akun untuk mulai mencatat aksi, mengikuti tantangan, dan
                memberi dampak positif bagi bumi.
              </p>
            </div>
            ...
            <div className="bg-white rounded-[40px] p-10 lg:p-12 shadow-2xl shadow-[#11773D]/10 border border-gray-100 w-full relative z-10 flex flex-col items-center">
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <label
                    htmlFor="name"
                    className="text-base font-bold text-[#0B0F1F]"
                  >
                    Nama Lengkap
                  </label>
                ...
                <div className="flex items-start gap-3 mt-2">
                  ...
                  >
                    Saya setuju dengan{" "}
                    <Link href="#" className="text-[#11773D] hover:underline">
                      Syarat & Ketentuan
                    </Link>{" "}
                    dan{" "}
                    <Link href="#" className="text-[#11773D] hover:underline">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex w-full items-center justify-center gap-3 rounded-2xl bg-[#11773D] py-4 mt-4 text-base font-bold text-white transition hover:bg-[#0b5f31] disabled:cursor-not-allowed disabled:opacity-70"
                >
                  {isLoading ? (
                    <>
