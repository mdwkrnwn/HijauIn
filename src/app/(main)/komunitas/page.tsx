  ...
  return (
    <div className="bg-gray-50 flex flex-col items-center w-full pb-24">
      ...
      <section className="relative w-full h-[700px] flex items-center px-16 bg-white overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-3xl">
          ...
          <h1 className="text-7xl mb-8 font-extrabold leading-tight text-gray-900">
            ...
            <span className="text-primary">Mengubah Dunia</span>
          </h1>
      ...
      <section className="max-w-1080p relative w-full px-16 py-24 mx-auto">
        <div className="flex items-end justify-between mb-12">
          <h2 className="text-4xl font-bold text-gray-900">
            Jelajahi Komunitas Hijau <FaLeaf className="text-primary inline" />
          </h2>
        ...
        <div className="relative">
          <div className="grid grid-cols-5 gap-6">
            {[
              ...
              <div
                key={idx}
                className="rounded-3xl hover:shadow-xl group flex flex-col overflow-hidden transition bg-white border border-gray-200"
              >
                <div className="relative h-48 overflow-hidden">
                  <Image
                    src={`https://picsum.photos/seed/${com.img}/400/300`}
                    alt={com.title}
                    fill
                ...
                <div className="flex flex-col justify-between flex-grow p-6 pt-10">
                  ...
                  <div>
                    <div className="text-primary flex items-center gap-2 mb-6 text-base font-bold">
                      <FaUsers />{" "}
                      <span className="text-gray-700">{com.mem} anggota</span>
                    </div>
      ...
      <section className="max-w-1080p w-full px-16 pb-24 mx-auto">
        <div className="flex items-end justify-between mb-12">
          <h2 className="text-4xl font-bold text-gray-900">
            Kegiatan Mendatang <FaLeaf className="text-primary inline" />
          </h2>
          <button className="text-primary hover:underline flex items-center gap-2 text-lg font-bold">
          ...
          {[
            {
              ...
              date: "25",
              month: "MEI",
              title: "Aksi Tanam 1.000 Pohon di Bukit Hijau",
              loc: "Bogor, Jawa Barat",
            ...
            >
              <div className="relative h-48 overflow-hidden">
                <Image
                  src={`https://picsum.photos/seed/${act.img}/400/300`}
                  alt={act.title}
                  fill
                  className="group-hover:scale-105 object-cover transition duration-500"
                />
              ...
              <div className="flex flex-col flex-grow p-6">
                <h3 className="flex-grow mb-4 text-xl font-bold leading-tight text-gray-900">
                  {act.title} <FaLeaf className="text-primary inline ml-1" />
                </h3>
                ...
                <div className="flex items-center gap-2 mb-6 text-base font-medium text-gray-500">
                  <FaRegClock className="text-primary flex-shrink-0" />{" "}
                  {act.time}
                </div>
                <div className="flex items-center gap-3 mb-6">
                  <div className="flex -space-x-3">
                    <div className="relative w-10 h-10 overflow-hidden bg-gray-200 border-2 border-white rounded-full">
                      <Image
      ...
      <section className="w-full px-16 py-24 bg-white">
        ...
        <div className="max-w-1080p relative flex items-start justify-between mx-auto">
          ...
          {impacts.map((item, index) => (
            <div
              key={index}
              className="relative z-10 flex flex-col items-center w-56 px-2 text-center bg-white"
            >
      ...
      <section className="max-w-1080p w-full px-16 pb-24 mx-auto bg-white">
        <div className="bg-[#14532d] rounded-[3rem] p-12 flex items-center justify-between shadow-xl relative overflow-hidden gap-10">
          ...
          <div className="w-1/3 h-[300px] relative rounded-3xl overflow-hidden shadow-inner">
            <Image
              src="https://picsum.photos/seed/commcta/600/600"
              alt="Join Community"
              fill
              className="object-cover"
            />
          ...
          <div className="flex flex-col justify-center w-1/3 text-white">
            ...
            <p className="mb-10 text-lg leading-relaxed text-gray-300">
              Satu aksi kecil dari kita, bisa menjadi perubahan besar untuk masa
            ...
            <ul className="space-y-6 text-base text-gray-200">
              <li className="flex justify-between items-center border-b border-[#1b5e33] pb-4">
                <span className="flex items-center gap-3">
                  <FaLeaf className="text-primary-light text-xl" /> Aksi Hijau
                </span>
                <span className="text-xl font-bold text-white">245</span>
              </li>
              <li className="flex justify-between items-center border-b border-[#1b5e33] pb-4">
                <span className="flex items-center gap-3">
                  <FaCloud className="text-primary-light text-xl" /> CO₂
                  Berhasil Dikurangi
                </span>
              ...
              <li className="flex justify-between items-center border-b border-[#1b5e33] pb-4">
                <span className="flex items-center gap-3">
                  <FaTrashAlt className="text-primary-light text-xl" /> Sampah
                  Terkumpul
                </span>
              ...
              <li className="flex items-center justify-between">
                <span className="flex items-center gap-3">
                  <FaTree className="text-primary-light text-xl" /> Pohon
                  Ditanam
                </span>
