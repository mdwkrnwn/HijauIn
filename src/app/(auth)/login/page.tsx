  ...
  return (
    <div className=" w-full bg-white rounded-[3rem] shadow-2xl overflow-hidden flex min-h-200">
      ...
      <div className="w-1/2 p-16 bg-white">
        <div className="mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Selamat Datang Kembali! <FaLeaf className="inline text-primary" /></h2>
        ...
        <form className="space-y-8">
          <div>
            ...
            <input type="text" placeholder="Masukkan email atau nomor telepon" className="w-full px-6 py-4 rounded-xl border border-gray-300 text-base focus:ring-2 focus:ring-primary outline-none" />
          </div>
          <div>
            <label className="block text-base font-bold text-gray-700 mb-3">Kata Sandi</label>
            <div className="relative">
              <input type="password" placeholder="Masukkan kata sandi" className="w-full px-6 py-4 rounded-xl border border-gray-300 text-base focus:ring-2 focus:ring-primary outline-none" />
              <FaEyeSlash className="absolute right-6 top-5 text-xl text-gray-400 cursor-pointer" />
            </div>
            <div className="text-right mt-3">
              <Link href="#" className="text-primary font-bold text-base hover:underline">Lupa kata sandi?</Link>
            </div>
          </div>

          <button type="button" className="w-full bg-primary text-white py-5 rounded-xl font-bold text-lg hover:bg-green-700 transition flex items-center justify-center gap-3">
            <FaUser /> Masuk
          </button>
        </form>
