...
export default function Edukasi() {
  return (
    <div className="w-full flex flex-col items-center pb-24">
      {/* Hero Section */}
      <section className="w-full px-16 py-24 bg-linear-to-br from-brand-light to-white flex justify-between items-center relative overflow-hidden">
        <div className="w-1/2 z-10">
          <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full text-brand font-semibold text-base mb-6 shadow-sm border border-green-100">
          ...
          <div className="flex bg-white rounded-full p-2 shadow-md border border-gray-200 max-w-xl mb-6">
            ...
            <button className="bg-brand text-white w-14 h-14 rounded-full flex items-center justify-center text-xl hover:bg-green-700">
              <FaSearch />
            </button>
          </div>
          <div className="flex gap-4 items-center">
            <span className="text-base font-bold text-gray-700">Topik Populer:</span>
            <span className="bg-white px-4 py-2 rounded-full text-base border border-gray-200 flex items-center gap-2"><FaRecycle className="text-brand" /> Sampah & Daur Ulang</span>
            <span className="bg-white px-4 py-2 rounded-full text-base border border-gray-200 flex items-center gap-2"><FaLightbulb className="text-brand" /> Hemat Energi</span>
          </div>
        </div>
      ...
      <section className="w-full px-16 py-16">
        <div className="flex justify-between items-end mb-10">
          <h2 className="text-4xl font-bold text-gray-900">Rekomendasi untuk Kamu <FaLeaf className="inline text-brand" /></h2>
          <button className="text-brand font-bold text-lg hover:underline">Lihat Semua &rarr;</button>
        </div>
          ...
          {[
            ...
            <div key={idx} className="bg-white border border-gray-200 rounded-3xl overflow-hidden hover:shadow-xl transition cursor-pointer group">
              <div className="h-64 relative overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur px-4 py-2 rounded-full text-brand font-bold text-base">
                  {item.tag}
                </div>
              </div>
              <div className="p-6">
      ...
      <section className="w-full px-16 py-16 bg-gray-50">
        <h2 className="text-4xl font-bold text-gray-900 mb-10">Kategori Edukasi <FaLeaf className="inline text-brand" /></h2>
        <div className="grid grid-cols-6 gap-6">
          {[
            ...
            <div key={idx} className="bg-white border border-gray-200 rounded-2xl p-8 flex flex-col items-center text-center hover:border-brand transition cursor-pointer">
              <div className="text-5xl text-brand mb-6">{cat.icon}</div>
      ...
      <section className="w-full px-16 py-16">
        <div className="flex justify-between items-end mb-10">
          <h2 className="text-4xl font-bold text-gray-900">Video Edukasi Pilihan <FaLeaf className="inline text-brand" /></h2>
          <button className="text-brand font-bold text-lg hover:underline">Lihat Semua &rarr;</button>
        </div>
        <div className="grid grid-cols-4 gap-8">
          {[
      ...
      <section className="w-full px-16 mt-16">
        <div className="bg-brand-light rounded-3xl p-16 flex items-center justify-between">
          <div className="max-w-2xl">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Terus Belajar, Terus Beraksi untuk Bumi yang <span className="text-brand">Lebih Baik</span></h2>
            ...
            <div className="flex bg-white rounded-xl p-2 shadow-sm border border-gray-200">
              ...
              <button className="bg-brand text-white px-8 py-4 rounded-lg font-bold text-base hover:bg-green-700">
                Berlangganan
              </button>
            </div>
          </div>
