...
export default function Features() {
  return (
    <div className="w-full flex flex-col items-center">
      {/* Header Section */}
      <section className="w-full px-16 py-24 text-center bg-gradient-to-b from-primary-light to-white">
        <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full text-primary font-semibold text-base mb-8 shadow-sm">
          <FaLeaf /> Fitur HijauIn
        </div>
        <h1 className="text-6xl font-extrabold text-gray-900 mb-8">
          Semua Fitur HijauIn <br /> Dalam <span className="text-primary">Satu Platform</span>
        </h1>
        ...
        <button className="bg-white border-2 border-primary text-primary px-8 py-4 rounded-full text-lg font-bold hover:bg-primary hover:text-white transition">
          Lihat Semua Fitur
        </button>
      </section>
      ...
      <section className="w-full px-16 py-16">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Fitur Unggulan <span className="text-primary">HijauIn</span></h2>
        ...
        <div className="grid grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="bg-white border border-gray-200 p-8 rounded-3xl hover:shadow-xl transition flex flex-col items-center text-center">
              <div className="w-20 h-20 bg-primary-light text-primary rounded-full flex items-center justify-center text-3xl mb-6">
                {item.icon}
              </div>
      ...
      <section className="w-full px-16 py-24 bg-gray-50">
        ...
        <div className="flex bg-white rounded-3xl overflow-hidden shadow-sm mb-12">
          ...
          <div className="w-1/2 p-16 flex flex-col justify-center">
            <div className="inline-flex items-center gap-3 text-primary text-2xl font-bold mb-6">
            ...
            <ul className="space-y-4 text-lg text-gray-600">
              <li className="flex items-center gap-3"><FaLeaf className="text-primary" /> Rekomendasi personal berdasarkan kebiasaanmu</li>
              <li className="flex items-center gap-3"><FaLeaf className="text-primary" /> Insight dampak lingkungan secara real-time</li>
              <li className="flex items-center gap-3"><FaLeaf className="text-primary" /> Tips harian untuk aksi yang lebih berdampak</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex bg-white rounded-3xl overflow-hidden shadow-sm mb-12 flex-row-reverse">
          ...
          <div className="w-1/2 p-16 flex flex-col justify-center">
            ...
            <ul className="space-y-4 text-lg text-gray-600">
              <li className="flex items-center gap-3"><FaLeaf className="text-primary" /> Poin dari setiap aksi yang kamu lakukan</li>
              <li className="flex items-center gap-3"><FaLeaf className="text-primary" /> Level dan Badge sebagai bentuk pencapaian</li>
              <li className="flex items-center gap-3"><FaLeaf className="text-primary" /> Track progress harian, mingguan, dan bulanan</li>
            </ul>
          </div>
        </div>
      </section>
