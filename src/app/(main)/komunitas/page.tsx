    ...
    <div className="w-full flex flex-col items-center pb-24">
      ...
      <section className="w-full h-175 relative flex items-center justify-start px-16">
        ...
        <div className="max-w-3xl text-white z-10">
          ...
          <h1 className="text-7xl font-extrabold leading-tight mb-6">
            Bersama Kita Bisa <br /> <span className="text-primary-light">Mengubah Dunia</span>
          </h1>
          ...
          <div className="flex gap-6">
            <button className="bg-primary text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-green-700 transition">
              Gabung Komunitas
            </button>
      ...
      <section className="w-full px-16 py-24">
        <div className="flex justify-between items-end mb-12">
          <h2 className="text-4xl font-bold text-gray-900">Jelajahi Komunitas Hijau <FaLeaf className="inline text-primary" /></h2>
          <button className="text-primary font-bold text-lg hover:underline">Lihat Semua Komunitas &rarr;</button>
        </div>
      ...
      <section className="w-full px-16 py-24 bg-gray-50">
        <h2 className="text-4xl font-bold text-center mb-16">Kenapa Gabung Komunitas HijauIn? <FaLeaf className="inline text-primary" /></h2>
        <div className="flex justify-between items-start relative max-w-6xl mx-auto">
          <div className="absolute top-12 left-0 w-full h-1 border-t-2 border-dashed border-primary-light z-0"></div>
          {[
            ...
            <div key={idx} className="flex flex-col items-center text-center relative z-10 w-48 bg-gray-50 px-2">
              <div className="w-24 h-24 bg-white border border-gray-200 rounded-full flex items-center justify-center text-4xl text-primary mb-6 shadow-sm">
                {item.icon}
              </div>
